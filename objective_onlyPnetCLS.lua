...
function create_objective(model, weights, gradient, batch_iterator, stats,confusion)
  ...
  --local cnet_input_planes = 0
  --if model.layers then
  --  cnet_input_planes = model.layers[#model.layers].filters
  --else
  --  cnet_input_planes = 256 -- only for AlexNet!!!
  --  cnet_input_planes = 512 -- only for VGG16!!!
  --end
